...
const Mfemme = ({ annonces, searchQuery }) => {
  ...
  useEffect(() => {
    ...
    const filteredByCategory = annonces.filter(annonce => annonce.category === 'mode-femme');
    ...
    <> 
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 p-6 relative">
        <div className="container mx-auto p-4">
          <h1 className="text-4xl font-extrabold text-center mb-8 text-orange-600">MODE FEMMME</h1>
