...
const Immobilier = ({ annonces }) => {
  ...
  useEffect(() => {
    // Filtrer les annonces par catégorie "immobilier"
    const filtered = annonces.filter(annonce => annonce.category === 'immobilier');
    setFilteredAnnonces(filtered);
  }, [annonces]);

  useEffect(() => {
    // Trier les annonces filtrées en fonction de l'option de tri
    ...
    <>
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 p-6 relative">
        <div className="container mx-auto p-4">
          <h1 className="text-4xl font-extrabold text-center mb-8 text-indigo-700">Catégorie: IMMOBILIER</h1>
