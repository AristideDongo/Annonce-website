...
const Vehicule = ({ annonces, searchQuery }) => {
    ...
    <> 
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 p-6 relative">
        <div className="container mx-auto p-4">
          <h1 className="text-4xl font-extrabold text-center mb-8 text-orange-600">VEHICULE</h1>
            ...
            {filteredAnnonces.length > 0 ? (
              filteredAnnonces.map((annonce) => (
                <div key={annonce.id} className="bg-white p-2 rounded-lg shadow-lg">
                  ...
                  <button
                    className="bg-green-500 w-full text-white py-2 px-4 rounded-lg hover:bg-green-600 transition duration-200 mt-2"
