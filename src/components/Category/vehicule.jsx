...
const Vehicule = ({ annonces }) => {
  ...
  useEffect(() => {
    // Filtrer les annonces par catégorie "vehicule"
    const filtered = annonces.filter(annonce => annonce.category === 'vehicule');
  ...
  useEffect(() => {
    ...
    setFilteredAnnonces(prevAnnonces => sortAnnonces([...prevAnnonces], sortOption));
  }, [sortOption]);
    ...
    <> 
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 p-6 relative">
        <div className="container mx-auto p-4">
          <h1 className="text-4xl font-extrabold text-center mb-8 text-indigo-700">Catégorie: VEHICULE</h1>
