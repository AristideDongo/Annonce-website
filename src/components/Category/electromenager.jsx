...
const Electromenager = ({ searchQuery }) => {
  ...
  useEffect(() => {
    ...
    const filteredByCategory = storedAnnonces.filter(annonce => annonce.category === 'electromenager');
  ...
  return (
    <div className="min-h-screen font-custom bg-gray-200 p-6 relative">
      <div className="container mx-auto p-4">
        <h1 className="text-4xl font-extrabold text-center mb-8 mt-16 text-[#333333]">ÉLECTROMÉNAGER</h1>
